        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <h2 className="mt-6 text-3xl font-bold text-[#1a1a2e] sm:text-4xl">
              ...
              <br />
              <span className="text-[#52527A]">Everything handled.</span>
            </h2>

            <p className="mt-6 font-[family-name:var(--font-urbanist)] text-base leading-relaxed text-[#52527A]">
              I&apos;m Max. I saw how business owners got stuck in manual work — processing quote requests, following up with clients, entering data — while AI can take over all of that. That frustrated me.
            </p>
            <p className="mt-4 font-[family-name:var(--font-urbanist)] text-base leading-relaxed text-[#52527A]">
              At NetjesOnline I build <span className="font-semibold text-[#1a1a2e]">AI automations and professional websites</span> that deliver real results. No fluff, no endless meetings — just a working system.
            </p>

            {/* What you get */}
            <div className="mt-8 space-y-3">
              {[
                "Personal — you call and message me directly",
                "Transparent — fixed prices, no hidden costs",
                "Fast — everything up and running within 2 weeks",
              ].map((item, i) => (
                <motion.div
                  key={i}
