        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            {isVakman && phoneDisplay && (
              <a
                href={phoneHref}
                className="hidden font-subheading text-sm font-semibold text-slate-700 transition-colors hover:text-slate-900 sm:inline-flex items-center gap-1.5"
              >
            ...
            <a
              ...
              className={`relative overflow-hidden rounded-full px-6 py-2.5 text-sm font-semibold transition-all duration-300 hover:scale-105 active:scale-95 ${
                isVakman
                  ? "bg-[#2563eb] text-white font-subheading hover:bg-[#1d4ed8]"
                  : scrolled
